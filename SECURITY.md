...
If you discover a security vulnerability within MediaFactory, please send an email to [fldx123456@163.com](mailto:fldx123456@163.com). All security vulnerabilities will be promptly addressed.
...
### Data Handling
- MediaFactory processes video files locally and does not transmit data to external servers
...
For secure usage of MediaFactory:

1. **Keep dependencies updated**
   ```bash
   pip install --upgrade mediafactory
   ```

2. **Use virtual environments**
   ```bash
   python -m venv mediafactory-env
   source mediafactory-env/bin/activate
   ```
